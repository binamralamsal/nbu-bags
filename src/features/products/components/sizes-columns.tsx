...
import { deleteSizeAction } from "@/features/products/server/products.actions";
...
export type SizesAllowedKeys = keyof Size;
  ...
  },
  {
    ...
    cell: function CellComponent({ row }) {
      ...
      async function handleDeleteSize() {
        const response = await deleteSizeAction(row.original.id);
        ...
        >
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <Link href={`/admin/products/sizes/edit/${size.id}`}>Edit</Link>
            </DropdownMenuItem>
            <AlertDialog
