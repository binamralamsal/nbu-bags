...
import { deleteColorAction } from "@/features/products/server/products.actions";
...
export type ColorsAllowedKeys = keyof Color;
  ...
  },
  {
    ...
    cell: function CellComponent({ row }) {
      ...
      async function handleDeleteColor() {
        const response = await deleteColorAction(row.original.id);
        ...
        >
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem asChild>
              <Link href={`/admin/products/colors/edit/${color.id}`}>Edit</Link>
            </DropdownMenuItem>
            <AlertDialog
